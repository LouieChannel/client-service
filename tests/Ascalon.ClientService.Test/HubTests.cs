    ...
    public class HubTests : SimpleServerFixture
    {
        ...
        public async Task CreateTask()
        {
            try
            {
                ...
                await logistConnection.InvokeAsync(nameof(LogistHub.CreateTask), "{\"DriverId\":2,\"Description\":\"test\",\"StartLongitude\":50.1354,\"StartLatitude\":30.4324,\"EndLongitude\":1.4342,\"EndLatitude\":43.1234,\"Status\":1,\"Entity\":\"dasfas\"}");
